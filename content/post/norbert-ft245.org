...
So [[https://github.com/ArthurHeymans/NORbert][NORbert]] has an FT245 transport now. It also does dual and quad I/O SPI reads, and the chip identity is runtime configurable. Here's what happened since the last post.
